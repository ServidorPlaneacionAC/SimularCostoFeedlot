...
class Cls_Cargar_Datos:
    ...
    def InicializarDatos(self):
        ...
        Datos = {
            "Fijos Alimento Mes": [8739605],
            "Variable Alimento Mes": [11783432],
            "Variable Energeticos Alimento Mes": [3904343],
            "Variable MDO Alimento Res /Mes": [6476254],
            "Fijos Producción Mes": [53464981],
            "Variable Producción Mes": [2746430],
            "Fijos Energeticos Producción Mes": [3218670],
            "Variable MDO Producción Mes": [12952509],
            "Fijos Proyectos infraestructura Mes": [19877000],
            "Variable Plan Sanitario 3 meses/res": [9293],
            "MDO Valor x persona": [3238127]
        }
        return Datos
    ...
    def definir_parametros(self,escenario):
        ...
        default_values = {
            ...
            'Numero de Reses Salida': 660,
            'Tiempo permanencia': 95,
            'Peso Inicial': 200.0,
